...
const Toast = forwardRef(({
  ...
  const variants = {
    default: 'bg-white text-secondary-900 border-secondary-200 dark:bg-secondary-800 dark:text-secondary-100 dark:border-secondary-700',
  ...
  const baseClasses = 'border rounded-lg p-4 shadow-lg transition-all duration-300 ease-in-out max-w-sm'
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className={cn('text-sm', title && 'text-sm opacity-90')}>
            {children}
          </div>
        </div>
